...
public class EoT_MQTT_Client implements MqttCallback {
    ...
    public int uploadFile(String srcDir, String dstName) throws Exception{
        ...
        MqttMessage message2 = new MqttMessage((Integer.toString(data.length / total_length + 1) + " " + dstName).getBytes());
        message2.setQos(qos);
    ...
    int uploadProgram(String srcDir) throws Exception {
        ...
        int total_length = 1024;
        //message 1 (buffer length)
        MqttMessage message2 = new MqttMessage((Integer.toString(data.length / total_length + 1) + " dummy.d").getBytes());
        message2.setQos(qos);
