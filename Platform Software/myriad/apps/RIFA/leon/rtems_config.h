...
#define CONFIGURE_MAXIMUM_SEMAPHORES (8 * RTEMS_DOSFS_SEMAPHORES_PER_INSTANCE)
...
BSP_SET_CLOCK(SYS_CLK_KHZ, PLL_DESIRED_FREQ_KHZ, 1, 1,DEFAULT_RTEMS_CSS_LOS_CLOCKS,  MSS_CLOCKS,  APP_UPA_CLOCKS,  APP_SIPP_CLOCKS, 0x0);
