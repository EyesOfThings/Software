...
public class MQTT_Client implements MqttCallback {
    ...
    private String m_fileDestinationPath;
    private String m_paths[];
    private int m_result;
    private Bitmap m_image;
    private String m_currentDeviceDate;
        ...
        subscribe(MQTT_Client.TOPIC_EOT_UPLOAD_FILE_SD, m_qualityOfService, new OnResultListener() {
            ...
            public void onSuccess(@Nullable Object result) {
                ...
                try {
                    ...
                    m_upload_data = new byte[(int) sourceFile.length()];
    ...
    public void messageArrived(String topic, MqttMessage message) throws Exception {
        //Log.v("messageArrived", "Topic: " + topic + ", Message: " + message.toString());
        ...
        switch (topic) {
            ...
            case MQTT_Client.TOPIC_EOT_UPLOAD_ELF:
                ...
                int uploadElfResult = Integer.parseInt(new String(message.getPayload()));
                if (null != mReceivedCallback) {
