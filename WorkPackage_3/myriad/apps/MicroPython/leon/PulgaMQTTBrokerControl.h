...
/*int send_show_image(int image_to_save, pulgamqttbroker *pulga, topic_subscriptions *aux_t, unsigned int s, int sleep_packages, int payload_max, unsigned char dup2, int qos2, unsigned char retained2, unsigned short packetid2, MQTTString topicName2);*/
